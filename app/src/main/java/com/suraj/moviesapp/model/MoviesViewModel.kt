...
import com.suraj.moviesapp.ui.UiModel
...
sealed class MovieSearchUiModel : UiModel {
...
sealed class FavoritesUiModel : UiModel {
...
sealed class MovieDetailUiModel : UiModel {
...
class MoviesViewModel @Inject constructor(private val moviesRepository: MoviesRepository) :
    ...
    private val _movieQueryResult = MutableLiveData<MovieSearchUiModel>()
    val movieQueryResult: LiveData<MovieSearchUiModel> = _movieQueryResult

    private val _favoriteResult = MutableLiveData<FavoritesUiModel>()
    val favoriteResult: LiveData<FavoritesUiModel> = _favoriteResult

    private val _detailResult = MutableLiveData<MovieDetailUiModel>()
